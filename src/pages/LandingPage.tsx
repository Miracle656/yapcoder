...
export function LandingPage() {
    ...
    // Default to dark colors if theme is undefined or system calls for it (simplified logic)
    const isDark = theme === "dark" || (theme === "system" && window.matchMedia("(prefers-color-scheme: dark)").matches)

    // Colors:
    // Light: White (#ffffff) & Purple (#8b5cf6)
    // Dark: Black (#000000) & Purple (#7c3aed)
    const colorA = isDark ? "#000000" : "#ffffff"
    const colorB = isDark ? "#5b21b6" : "#ddd6fe" // Deep purple vs Light purple
    const baseColor = isDark ? "#4c1d95" : "#8b5cf6"
        ...
        <main className="relative h-screen w-full overflow-hidden bg-background">
            ...
            >
                <Shader className="h-full w-full">
                    ...
                    <ChromaFlow
                        baseColor={baseColor}
                        upColor={isDark ? "#2e1065" : "#f3e8ff"}
                        downColor={isDark ? "#000000" : "#ffffff"}
                        leftColor={colorB}
                        rightColor={colorB}
                        intensity={0.9}
                        radius={1.8}
                    ...
                    <div className="max-w-3xl">
                        ...
                        <p className="mb-8 max-w-xl animate-in fade-in slide-in-from-bottom-4 text-lg leading-relaxed text-foreground/90 duration-1000 delay-200 md:text-xl">
                            <span className="text-pretty">
                                Real-time analytics, developer insights, and project discovery for the Sui blockchain.
                            </span>
                        </p>
